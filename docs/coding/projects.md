...
<iframe width="560" height="315" src="https://www.youtube.com/embed/dDbrtulcTWE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
While I can't make any promises as to project content or release date, I plan to write some OpenCL applications in the near future in order to get a better handle on GPU acceleration and code optimization.

## Licensing

Unless otherwise specified, the source code *and* binaries for my coding projects have all rights reserved. Most of my projects are Creative Commons licensed. To locate licensing information for a specific project, check the README file on the GitHub page.

If you wish to use any of my projects for purposes that exceed the posted license, please email me at [rayyawspeedruns@gmail.com](mailto:rayyawspeedruns@gmail.com). If you require an urgent response, please message me on Discord at RileyTech#9909.
